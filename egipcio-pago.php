        ...
        <div class="col-12 col-sm-12 col-md-12 col-xl-9 col-lg-9">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 text-center">
                                    ...
                                    <img class="cart-image"
                                         src="assets/img/promos/<?php echo $itemCarrito['imagenProducto'] ?>" alt="">
                                </div>
                                        ...
                                        <div class="row mt-1">
                                            <div class="col text-center">
                                                <a onclick="mostrarLoading()"
                                                   href="script/cartAction.php?action=updateCartItem&id=<?php echo $itemCarrito['rowid']; ?>&qty=<?php echo $itemCarrito['qty'] - 1; ?>"
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1 text-center d-flex justify-content-center align-items-center">
                                    <div>
                                        <a onclick="mostrarLoading();"
                                           href="script/cartAction.php?action=removeCartItem&id=<?php echo $itemCarrito['rowid']; ?>"
            ...
            <div class="row mt-5 mb-4">
                <div class="col text-center text-xl-left text-lg-left">
                    <a class="btn btn-lg btn-danger animated infinite bounce slow btn-seguirComprando"
                       href="egipcio-carta.php">
                        SEGUIR COMPRANDO
                    </a>
                </div>
            </div>
                    ...
                    if ($_SESSION['solo_gift_cards'] == 'false') {
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col">
                                ...
                                <a style="cursor: pointer" class="text-info" onclick="openAddressSelectorModal()">Cambiar<i
            ...
            <div class="row mt-5">
                <div class="col text-center text-xl-left text-lg-left">
                    ...
                    if ($subtotal > 0) {
                        ...
                        if (isset($_SESSION['current_customer_idCliente'], $_SESSION['current_customer_email'])) {
                            ...
                            if ($subtotal < 18 && $_SESSION['envio'] != 'recojo') {
                                ...
                                <a onclick="pedidoMinimoAdvertencio()"
                                   class="btn btn-lg btn-danger animated infinite tada slow btn-pedir font-weight-bolder">
                                    PAGAR
                                </a>
                                <?php
                            } else {
                                ?>
                                <a onclick="goToCheckout()"
                                   class="btn btn-lg btn-danger animated infinite tada slow btn-pedir font-weight-bolder"
                                >
                                    PAGAR
                                </a>
                        ...
                        <?php } else {
                            ?>
                            <a class="btn btn-lg btn-danger animated infinite tada slow btn-pedir font-weight-bolder"
            ...
            <div class="row mb-3">
                <div class="col text-center">
                    <div class="progress" style="border: 2px solid #9C0001;">
                        <div class="progress-bar progress-bar-complementos progress-bar-striped progress-bar-animated"
                             role="progressbar" style="width: <?php echo $progressWidth; ?>%" aria-valuenow="100"
