    ...
    <div class="container">
        <div class="row text-center text-center text-sm-left text-md-left mt-5">
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 mt-3">
                ...
                <ul class="list-unstyled text-center">
                    <li class="mt-3"><a target="_blank" href="https://www.facebook.com/elegipcio.pe"><img
                                    class="animated infinite jello slow" width="60px"
                                    src="assets/img/footer/icono-fb.png" alt=""><br>Siguenos en Facebook</a>
                    </li>
                    <li class="mt-3"><a target="_blank" href="https://www.instagram.com/elegipcio.pe/"><img
                                    class="animated infinite jello slow" width="60px"
                                    src="assets/img/footer/icono-instagram.png" alt=""><br>Siguenos en Instagram</a>
                    </li>
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 mt-3">
                ...
                <ul class="list-unstyled text-center">
                    ...
                    <li class="mt-3">
                        <a target="_blank" href="#">
                            <img width="60px"
                                 src="assets/img/icons/covid-19.png" alt="">
                            <br>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                <p>
                    <a style="font-size: 18px; color: #FFFFFF;" href="cv.php">Bolsa de Trabajo </a>|<a
                            style="font-size: 18px; color: #FFFFFF;" href="blog.php"> BLOG </a>| <a href="terminos.php">
                        Terminos y Condiciones</a>
                </p>
                <p class="h6">&copy Todos los Derechos Reservados.<a class="text-green ml-2"
                                                                     href="https://enfocussoluciones.com"
                                                                     target="_blank">El Egipcio - Enfocus</a></p>
            </div>
            <hr>
        </div>
    </div>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h3 class="text-center m-auto">CAMBIAR DIRECCIÓN <img class="mb-2" src="assets/img/egypt.png" alt=""
                                                                      style="width: 35px"></h3>
            </div>
                    ...
                    <form class="col" id="formStoreSelector">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input onclick="selectShippinMethodClick(this)" value="DELIVERY" name="tipoReparto" checked class="d-none" type="radio"
                                    ...
                                    <div class="col">
                                        <input onclick="selectShippinMethodClick(this)" value="RECOJO" name="tipoReparto" class="d-none" type="radio"
