...
<!--iphone icons-->
<link rel="apple-touch-icon" href="pwa/icons/apple-touch-icon-144x144.png">
...
<script src="assets/js/googleSignIn.js"></script>
    ...
    <!-- Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129717590-3"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-129717590-3');
</script>



<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyArTyoCYqHm0479cO0A1WNMv3w1X0uLjQo&libraries=places"
></script>
...
src="https://www.facebook.com/tr?id=701036463903289&ev=PageView&noscript=1"
