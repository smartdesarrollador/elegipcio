...
class Pedido
{
    ...
    public function addPedido($idCliente, $direccionPedido, $pedidoTelefono, $pedidoObservaciones,
                              $precioTotal, $puntosGanados, $lastFour, $cardNumber, $horaPedido,
                              $brand, $saldoReducido = 0, $delivery = 'true', $distrito, $documento, $razonSocial, $direccionFiscal, $ruc, $latitud, $longitud, $costoEnvioPagado = 0, $idtienda = 0)
    {
